...
ressurection10 = Button(root, text="Tyn `Anactacin", font=copticFont, bg="black", fg="white", command=lambda: [TA.teenAnastaseen()])
...
myImg10 = ImageTk.PhotoImage(Image.open("Imgs/resImg.jpeg"))
img10Label = Label(image=myImg1)
img10Label.grid(row=4, column=4)
ressurection10.grid(row=5, column=4)
