...
def KA():
    ...
    def audio():
        ...
        if x <= 1:
            ...
            song1 = "/Volumes/My Passport/Programming/Python/PyApp/audio/Khristos Anesti Oliver and Jan Youssef.mp3"
            song1 = song1.replace("/Volumes/My Passport/Programming/Python/PyApp/audio/", "")
            song1 = song1.replace(".mp3", "")
            song2 = "/Volumes/My Passport/Programming/Python/PyApp/audio/Khristos Anesty Ibrahim Ayad.mp3"
