...
def oNimNai():
    ...
    def audio():
        ...
        if x <= 1:
            ...
            song1 = "/Volumes/My Passport/Programming/Python/PyApp/audio/O Nim Nai Ibrahim Ayad.mp3"
            song1 = song1.replace("/Volumes/My Passport/Programming/Python/PyApp/audio/", "")
            song1 = song1.replace(".mp3", "")
            song2 = "/Volumes/My Passport/Programming/Python/PyApp/audio/O Nim Nai St Mark JC Deacons.mp3"
    ...
    khristosanestee = Label(res,
                            text="`w nim naicumvwnia =g", font=copticFont)
    english_KA = Label(res,
                       text="(Oh what are these symphonies)3", font=englishFont)

    kaHeading = Label(res, text="`w nim nai", font=cHeading)
